...
class Product:
    def __init__(self, name, purchase_price, sell_price, quantity=1, stak=False, income=1, image_path="SG Picture/Sword.png"):
        self.name = name
...
class Shop:
    def __init__(self, name):
        self.name = name
        self.shop_list = [
            Product(name="Меч", purchase_price=250, sell_price=200, stak=False, income=6, image_path="SG Picture/RedGem_Sword.png"),
            Product(name="Апельсин", purchase_price=50, sell_price=30, quantity= 10, stak=True, income=1, image_path="SG Picture/Orange.png"),
            Product(name="Лук", purchase_price=350, sell_price=270, stak=False, income=8, image_path="SG Picture/Bow.png"),
            Product(name="Яблоко", purchase_price=50, sell_price=30, quantity=2, stak=True, income=1, image_path="SG Picture/Red_Aplle.png"),
            Product(name="Арбуз", purchase_price=100, sell_price=80, quantity=5, stak=True, income=2, image_path="SG Picture/Arbyz.png"),
            Product(name="Меч Хуже", purchase_price=200, sell_price=160, stak=False, income=5, image_path="SG Picture/Sword.png"),
